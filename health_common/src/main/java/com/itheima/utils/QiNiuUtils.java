...
public class QiNiuUtils {
    ...
    private static final String ACCESSKEY = "5vfDmCESr7M3Z_GWwYOFSdn3AuuHxSlVAAPEWLhl";
    private static final String SECRETKEY = "-btzpEQjxdB0H7T5mtk-dEbdUbRMyRQfDeFeXhUE";
    private static final String BUCKET = "hibernatehibernate";
    public static final String DOMAIN= "http://qmjzg7acs.hn-bkt.clouddn.com/";
    ...
    public static String uploadViaByte(byte[] bytes, String savedFilename){
        UploadManager uploadManager = getUploadManager();
        String upToken = getToken();
        try {

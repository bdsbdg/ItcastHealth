...
public interface MessageConstant {
    ...
    static final String QUERY_MENU_SUCCESS = "获取全部菜单成功";
    static final String ADD_MENU_1_SUCCESS = "添加根菜单成功";
    static final String ADD_MENU_2_SUCCESS = "添加子菜单成功";
    static final String EDIT_MENU_SUCCESS = "编辑菜单成功";
    static final String DELETE_MENU_SUCCESS = "删除菜单成功";
    static final String QUERY_MENU_BYID_SUCCESS = "查询菜单成功";
    ...
    static final String UPDATE_PERMISSION_SUCCESS = "更新权限成功";
    ...
    static final String UPDATE_ROLE_SUCCESS = "更新角色成功";
    static final String ADD_ROLE_SUCCESS = "添加角色成功";
    static final String SETMEAL_ALL_KEY = "setmeal:all";
    static final String QUERY_PM_SUCCESS = "查询权限与父菜单成功";
    ...
    static final String UPDATE_USER_SUCCESS = "更新用户成功";
    static final String ADD_USER_SUCCESS = "添加用户成功";
    static final String DATE_FORMAT_ERROR = "日期格式不正确";
    static final String DATE_RANGE_ERROR = "日期范围不正确";
}